...
Это пет-проект, демонстрирующий создание защищенного бэкенда на Java + Spring Boot. Включает регистрацию, логин, CRUD для задач и документацию через Swagger.
